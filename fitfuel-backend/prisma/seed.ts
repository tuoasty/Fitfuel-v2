...
async function main(){
    ...
    await prisma.profile.createMany({
        data: [
            {id:"b1743b42-067d-4e8a-8576-aeb6698b7977", userId:"1bfbc920-1517-4827-bf2f-622e828c387f", weight:50, height:173, dateOfBirth:new Date(Date.now()),
            ...
            {id:"61c15379-348a-43e9-b6b3-8a93967f8ce1", userId:"dc8b5570-7735-4184-952a-27aa31cd8d90", weight:50, height:175, dateOfBirth:new Date(Date.now()),

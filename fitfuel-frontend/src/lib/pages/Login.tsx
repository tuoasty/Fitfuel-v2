...
export default function Login() {
    ...
    return (
        <main className="relative w-full h-full overflow-hidden bg-background text-foreground flex flex-col justify-center items-center">
            <img src={background || "/placeholder.svg"} className="w-full h-full absolute opacity-15 object-cover" />
            <Card className="relative flex flex-row bg-background w-[75%] h-[75%] z-20 rounded-2xl shadow-lg overflow-hidden border-0 p-0 m-0">

            ...
            <div className="container mx-auto px-4 py-6 bg-background min-h-screen">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <Card className="bg-accent">
                        <CardContent className="p-6 text-center">
                            <div className="mb-2">
                                <svg className="w-8 h-8 mx-auto text-primary" fill="none" stroke="currentColor"
                                     viewBox="0 0 24 24">
                    ...
                    <CardContent className="p-6">
                        ...
                        <div className="space-y-4">
                            {mealTypes.map((mealType) => {
                                ...
                                return (
                                    <Card key={mealType}
                                          className="mb-6 bg-cover bg-center bg-no-repeat bg-gradient-to-b pt-0 from-secondary to-foreground bg-blend-overlay">
                                        <div className="relative mt-6" onClick={() => navigate(`/recipe/${recipe.id}`)}>
                                            <div
                                                className="absolute -top-2 -right-2 sm:-right-4 bg-destructive text-background px-3 py-1 sm:px-4 sm:py-2 rounded-lg z-10 text-sm font-medium shadow-lg transform hover:scale-105 transition-transform duration-200 border-2 border-destructive">
                                            ...
                                            <div className="flex flex-col sm:flex-row">
                                                ...
                                                <div
                                                    className="w-full sm:w-3/5 p-4 sm:p-6 text-white flex flex-col justify-center">
